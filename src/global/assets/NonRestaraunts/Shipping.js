  ...
  return (
    <svg id='Flat' height='512' viewBox='0 0 512 512' width='512' xmlns='http://www.w3.org/2000/svg'>
      <g>
        ...
        <g>
          <path
            d='m472 88a64 64 0 1 0 -105.384 48.821l41.384 55.179 41.384-55.179a63.859 63.859 0 0 0 22.616-48.821z'
            fill='#fa5d3f'
          />
        ...
        <g>
          ...
          <path
            d='m50 352h140a10 10 0 0 1 10 10v94a0 0 0 0 1 0 0h-160a0 0 0 0 1 0 0v-94a10 10 0 0 1 10-10z'
            fill='#fac850'
          />
          <path
            d='m254 456h-62v-88h49.23a10 10 0 0 1 9.284 6.286l13.486 33.714v38a10 10 0 0 1 -10 10z'
            fill='#ff7f45'
          />
          <path d='m200 368v40h64l-13.486-33.714a10 10 0 0 0 -9.284-6.286z' fill='#f1c59f' />
          <g>
            <path
              d='m332 264h56a28.032 28.032 0 0 0 28-28v-20h-16v20a12.013 12.013 0 0 1 -12 12h-56a36 36 0 0 0 0 72h24a20 20 0 0 1 0 40h-76v16h76a36 36 0 0 0 0-72h-24a20 20 0 0 1 0-40z'
              fill='#ff7f45'
            />
